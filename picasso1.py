...
async def turnLeft(degrees):
    ...
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, turnDegrees, -200, 200, acceleration=500)
    sound.beep()
...
async def bananaboat():
    #await armDownByAngle()
    await tailUp()
    # await moveForward(2)
    # await turnRight(90)
    # await moveForwardByDecDisByspeed(4,280)
    # await turnLeft(90)
    await moveForwardByDecDisByspeed(45.75,300)
    await turnLeft(90)
